...
function buildCreditsPage() 
	...
	AddTextOption("$Russian", "TBA", OPTION_FLAG_DISABLED)
	AddTextOption("$Czech", "TBA", OPTION_FLAG_DISABLED)
	AddTextOption("$French", "TBA", OPTION_FLAG_DISABLED)
	AddTextOption("$Japanese", "TBA", OPTION_FLAG_DISABLED)
	AddEmptyOption()
